  ...
  return (
    <div>
      <div>
        ...
        <div className=" ms-16 left-nav">
          <Category />
        </div>
      </div>
      {/* side bar  */}
      <div
        className={` z-40 fixed flex flex-col w-fit items-start gap-2 h-screen bg-[#e9e9e9] rounded-e-2xl ${
          open ? " top-0 left-0" : " top-0 left-[-10000px]"
        }`}>
        <div className=" flex items-baseline gap-5 ps-6 pe-8 border-b border-gray-700 w-full">
          <div className=" hover:bg-[#d2d2d2] px-3 py-2 rounded-full items-center">
            <button className=" text-2xl" onClick={handleOpen}>
              <RxHamburgerMenu />
            </button>
          </div>
        ...
        <div className=" flex justify-start items-center w-[80%] rounded-full gap-5 hover:bg-[#d2d2d2] ms-6 px-3 py-1">
      ...
      {/* profile box  */}
      <div
        className={` fixed bg-[#e9e9e9] rounded shadow-md text-[#474747] ${
        ...
        <div className=" flex flex-col gap-1 border-b border-gray-500 pb-1">
          <div className=" px-8 py-2 flex gap-2 hover:bg-[#d2d2d2]">
            <h2 className=" text-2xl text-gray-700">
      ...
      {/* <div className=" absolute top-0 left-[-10000000px]">
        <Trending sidebarOpen={open} />
      </div> */}
    </div>
  );
};
