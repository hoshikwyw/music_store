...
const LeftNavbar = () => {
  return (
    <div className=" flex flex-col justify-start w-fit items-center gap-4">
      <NavLink to={'/'} className=" flex flex-col items-center w-fit gap-1 hover:bg-slate-300 px-3 py-1 rounded">
        <h2 className=" text-2xl text-gray-700">
          <AiOutlineHome />
        </h2>
        <h2 className=" text-xs">Home</h2>
      </NavLink>
      <NavLink to={'/like'} className=" flex flex-col items-center w-fit gap-1 hover:bg-slate-300 px-3 py-1 rounded">
        <h2 className=" text-2xl text-gray-700">
          <AiOutlineLike />
        </h2>
